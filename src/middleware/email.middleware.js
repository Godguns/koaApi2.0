...
async function sendEmail(){
    let transporter = nodemailer.createTransport({
        ...
        auth: {
          user: '2837673900@qq.com',
          // 这里密码不是qq密码，是你设置的smtp授权码
          // 获取qq授权码请看:https://jingyan.baidu.com/article/6079ad0eb14aaa28fe86db5a.html
          pass: 'lydccjywhkckdfjg',
        }
      });
      let mailOpt= {
        from: '2837673900@qq.com',  // 你到qq邮箱地址
        to: '1281424310@qq.com,524602659@qq.com,1248170672@qq.com,947617162@qq.com', // 接受人,可以群发填写多个逗号分隔
        subject: 'NXpixiv事务局', // 主题名(邮件名)
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td style='width:130px;'>
                                                        <img alt='Profile Picture' height='auto' src='https://q.qlogo.cn/g?b=qq&nk=2837673900&s=100' style='border:1px solid #ccc;border-radius:5px;display:block;font-size:13px;height:auto;outline:none;text-decoration:none;width:100%;' width='130' />
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                                </table>
